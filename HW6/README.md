...
1. Evaluate your application based on the principles of universal design. Comment on (a) 2 principles that you have followed, and (b) 2 principles that you may have violated.
  ...
  * Two principles that I have followed are "Principle 5: Tolerance for Error" and "Principle 6: Low Physical Effort". Tolerance for error is demonstrated by the various alerts that pop up when an action the user performs isn't successful. Additionally, registering, logging in and out, posting, and deleting posts require low physical effort and minimal repetive action (e.g., the user does not need to log back in again after they post a message)
  * On the otherhand, two principles that I may have violated are "Principle 3: Simple and Intuitive Use" and "Principle 2: Flexibility in Use". Principle 3 is violated because there is a lack of visual imagery to guide users through the website. Principle 2 is violated because my website does not provide a range of methods for users to use the site. 
...
![Sketch for step 10](_figures/HW6_Step10.jpg)
